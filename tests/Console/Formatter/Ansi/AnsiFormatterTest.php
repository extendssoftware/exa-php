...
class AnsiFormatterTest extends TestCase
{
     ...
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setForeground()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setColor()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::create()
     */
     ...
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::__construct()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::resetBuilder()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setBackground()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setColor()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::create()
     */
     ...
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::__construct()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::resetBuilder()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::addFormat()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setFormat()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::create()
     */
     ...
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::resetBuilder()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::addFormat()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::removeFormat()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setFormat()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::create()
     */
     ...
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::__construct()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::resetBuilder()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setFixedWidth()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::create()
     */
     ...
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::__construct()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::resetBuilder()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setTextIndent()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::create()
     */
     ...
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setForeground()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setColor()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\Exception\ColorNotSupported::__construct()
     */
     ...
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::addFormat()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\AnsiFormatter::setFormat()
     * @covers \ExtendsSoftware\ExaPHP\Console\Formatter\Ansi\Exception\FormatNotSupported::__construct()
     */
