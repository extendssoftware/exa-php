...
class Base64ValidatorTest extends TestCase
{
     ...
     *
     * @covers \ExtendsSoftware\ExaPHP\Processor\Validator\Text\Base64Validator::__construct()
     * @covers \ExtendsSoftware\ExaPHP\Processor\Validator\Text\Base64Validator::process()
     */
    public function testValid(): void
    {
        ...
        $result1 = $validator1->process('FfYkHoSJ5By549qTrEkl3ZDcJkHfJTMmrdcUPH/V+Vs='); // random_bytes(32)
        $result2 = $validator2->process('FfYkHoSJ5By549qTrEkl3ZDcJkHfJTMmrdcUPH-V_Vs'); // random_bytes(32)
     ...
     * @covers \ExtendsSoftware\ExaPHP\Processor\Validator\Text\Base64Validator::__construct()
     * @covers \ExtendsSoftware\ExaPHP\Processor\Validator\Text\Base64Validator::process()
     * @covers \ExtendsSoftware\ExaPHP\Processor\Validator\Text\Base64Validator::getTemplates()
     */
    public function testInvalid(): void
    {
        ...
        $result1 = $validator1->process('FfYkHoSJ5By549qTrEkl3ZDcJkHfJTMmrdcUPH-V+Vs='); // Replaced / with -.
        $result2 = $validator2->process('FfYkHoSJ5By549qTrEkl3ZDcJkHfJTMmrdcUPH/V_Vs='); // Replaced - with /.
    ...
    public function testDecodeFailed(): void
    {
        ...
        $result1 = $validator1->process('FfYkHoSJ5By549qTrEkl3ZDcJkHfJTMmrdcUPH/V+Vs=='); // Extra padding added.
        $result2 = $validator2->process('FfYkHoSJ5By549qTrEkl3ZDcJkHfJTMmrdcUPH-V_Vs=='); // Extra padding added.
    ...
    public function testDecodeEncode(): void
    {
        ...
        $result1 = $validator1->process('FfYkHoSJ5By549qTrEkl3ZDcJkHfJTMmrdcUPH/V+Vs'); // Removed padding.
        $result2 = $validator2->process('FfYkHoSJ5By549qTrEkl3ZDcJkHfJTMmrdcUPH/V+Vs='); // Added padding.
