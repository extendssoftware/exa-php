...
class UuidValidatorTest extends TestCase
{
     ...
     *
     * @covers \ExtendsSoftware\ExaPHP\Processor\Validator\Text\UuidValidator::process()
     */
    public function testValid(): void
    {
        $validator = new UuidValidator();

        $result1 = $validator->process('db6eb6f2-1dda-1f06-a995-1fd1aca99e1f'); // Version 1
        $result2 = $validator->process('db6eb6f2-1dda-2f06-a995-1fd1aca99e1f'); // Version 2
        $result3 = $validator->process('db6eb6f2-1dda-3f06-a995-1fd1aca99e1f'); // Version 3
        $result4 = $validator->process('db6eb6f2-1dda-4f06-a995-1fd1aca99e1f'); // Version 4
        $result5 = $validator->process('db6eb6f2-1dda-5f06-a995-1fd1aca99e1f'); // Version 5
     ...
     *
     * @covers \ExtendsSoftware\ExaPHP\Processor\Validator\Text\UuidValidator::process()
     * @covers \ExtendsSoftware\ExaPHP\Processor\Validator\Text\UuidValidator::getTemplates()
     */
    public function testInvalid(): void
    {
        $validator = new UuidValidator();
        $result1 = $validator->process('foo-bar-baz');
        $result2 = $validator->process('db6eb6f2-1dda-6f06-a995-1fd1aca99e1f'); // Version unknown
