...
class WhitespaceValidatorTest extends TestCase
{
     ...
     *
     * @covers \ExtendsSoftware\ExaPHP\Validator\String\WhitespaceValidator::factory()
     */
    public function testFactory(): void
    {
         ...
         */
        $validator = WhitespaceValidator::factory(WhitespaceValidator::class, $serviceLocator);
