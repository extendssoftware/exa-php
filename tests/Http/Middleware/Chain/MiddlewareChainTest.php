...
class MiddlewareChainTest extends TestCase
{
     ...
     *
     * @covers \ExtendsSoftware\ExaPHP\Http\Middleware\Chain\MiddlewareChain::__construct()
     * @covers \ExtendsSoftware\ExaPHP\Http\Middleware\Chain\MiddlewareChain::addMiddleware()
     * @covers \ExtendsSoftware\ExaPHP\Http\Middleware\Chain\MiddlewareChain::proceed()
     */
     ...
     *
     * @covers \ExtendsSoftware\ExaPHP\Http\Middleware\Chain\MiddlewareChain::__construct()
     * @covers \ExtendsSoftware\ExaPHP\Http\Middleware\Chain\MiddlewareChain::__clone()
     * @covers \ExtendsSoftware\ExaPHP\Http\Middleware\Chain\MiddlewareChain::addMiddleware()
     * @covers \ExtendsSoftware\ExaPHP\Http\Middleware\Chain\MiddlewareChain::proceed()
     */
