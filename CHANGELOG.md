...
- Added NumberParser processor to parse a numeric value to a float.
...
- Added soft-fail support for unauthorized resource expansions and attribute projections.
...
- Changed middleware order for HATEOAS middleware to have an identified request.
...
[unreleased]: https://github.com/extendssoftware/exa-php/compare/0.9.1...HEAD

[0.9.1]: https://github.com/extendssoftware/exa-php/commits/0.9.1
